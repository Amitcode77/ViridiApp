...
public class ProductDetailsActivity extends AppCompatActivity
{
    ...
    private void addingToCartList()
    {
       ...
       cartMap.put("price", shown_price);
        cartMap.put("date", saveCurrentDate);
        cartMap.put("time", saveCurrentTime);
        cartMap.put("quantity", numberButton.getNumber());
        cartMap.put("discount", "");
        cartMap.put("image", shown_image);
...
//                                                Toast.makeText(ProductDetailsActivity.this, shown_image, Toast.LENGTH_LONG).show();
                                                Intent intent = new Intent(ProductDetailsActivity.this,CraftMarketActivity.class);
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    shown_image = products.getImage();
                    Picasso.get().load(products.getImage()).into(productImage);


                    shown_price = products.getPrice();
                }
            }
